--[[
    Chat Censor for Lmaobox (RUS)
    Author: LNX (github.com/lnx00) | Russian adaptation: sikiu (github.com/SikiuSolution) 
]]
...
local function DispatchUserMessage( msg )
	...
	message = message:gsub("|", "я")
        ...
        string.find(message, "bot") or string.find(message, "чит") or
	string.find(message, "bot") or string.find(message, "читер") or
	string.find(message, "bot") or string.find(message, "кик") or
	string.find(message, "bot") or string.find(message, "аим") or
	string.find(message, "bot") or string.find(message, "бот") or
	string.find(message, "bot") or string.find(message, "боты") or
