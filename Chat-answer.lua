--[[
    Chat-answerLmaobox (RUS)
    Author: Lnx00 (https://github.com/lnx00) | Russian adaptation: sikiu (github.com/SikiuSolution) 
]]
...
local randMsg = {
    "?", "eblan", "no",
    "idi naxui", "ahahhahahahahahhahahah", "XD",
    "LOX", "LOOOL", "dolbaeb",
    "Why", "net", "pidar"
}
...
local function DispatchUserMessage( msg )
	...
	message = message:gsub("|", "я")
        ...
        string.find(message, "bot") or string.find(message, L"чит") or
	string.find(message, "bot") or string.find(message, L"читер") or
	string.find(message, "bot") or string.find(message, L"кик") or
	string.find(message, "bot") or string.find(message, L"аим") or
	string.find(message, "bot") or string.find(message, L"бот") or
	string.find(message, "bot") or string.find(message, L"боты") or
	string.find(message, "bot") or string.find(message, "bot") or
	string.find(message, "bot") or string.find(message, "bots") or
